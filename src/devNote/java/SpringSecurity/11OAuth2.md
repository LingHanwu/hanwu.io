...
![image-20220711201517843](./images/image-20220711201517843.png)
...
![image-20220625085816021](./images/image-20220625085816021.png)
...
![image-20220625090018332](./images/image-20220625090018332.png)
...
![image-20220625090540320](./images/image-20220625090540320.png)
...
![image-20220625090710221](./images/image-20220625090710221.png)
...
![image-20220625090900509](./images/image-20220625090900509.png)
...
![image-20220601100844019](./images/image-20220601100844019.png)

- 创建 OAuth App并输入一下基本信息:

![image-20220601101157267](./images/image-20220601101157267.png)

- 注册成功后会获取到对应的 Client ID 和 Client Secret。

![image-20220601101312113](./images/image-20220601101312113.png)
...
![image-20220601102620149](./images/image-20220601102620149.png)

- 点击 github 登录,点击授权 访问 hello 接口

![image-20220601102749454](./images/image-20220601102749454.png)
...
![image-20220811212147719](./images/image-20220811212147719.png)

```http
http://localhost:8080/oauth/authorize?client_id=client&response_type=code&redirect_uri=http://www.baidu.com
```

![image-20220811212242159](./images/image-20220811212242159.png)

点击授权获取授权码

![image-20220811212334084](./images/image-20220811212334084.png)
...
![image-20220811212426451](./images/image-20220811212426451.png)
...
![image-20220811212512798](./images/image-20220811212512798.png)
...
![image-20220811220339448](./images/image-20220811220339448.png)
...
![image-20220812153300057](./images/image-20220812153300057.png)
...
![image-20220812155121319](./images/image-20220812155121319.png)
...
![image-20220812160042315](./images/image-20220812160042315.png)